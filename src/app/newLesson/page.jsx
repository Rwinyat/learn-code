...
//           <div key={index} className=" grid justify-center m-5">
//             <h1 className="mt-8 text-2xl font-bold">{content.title[index]}</h1>
//             <p className="mt-4">
//               {content.desc[index]}
//             </p>
//             <p className="mt-4">
...
// export default function NewLesson() {
  ...
  // const steps = content[currentContentIndex].steps || [];
  ...
  return (
    <div>
      ...
      <div>
        ...
        {content[currentContentIndex] && (
          <div className="grid justify-center m-5">
            <h1 className="mt-8 text-2xl font-bold">{content[currentContentIndex].title}</h1>
            <p className="mt-4">{content[currentContentIndex].desc}</p>
            <p className="mt-4">An expression is a bit of JavaScript code that produces a value.</p>
            <p className="mt-4">Let's get started</p>
            <button
              type="button"
              class=" mt-4 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 me-2mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 w-28"
              onClick={() => setCurrentContentIndex(currentContentIndex + 1)}
            >
              Continue
            </button>
